...
@media only screen and (max-width: 550px) {
  ...
  <body>
      <div class="logo"><div class="container">
      	<img src="./pepperchatlogo.jpeg"/><h1>Amy</h1>
      </div></div>
      ...
      <div class="main"><div class="container"> <!-- start MAIN and CONTAINER -->
      	...
      	<div id="topPanel"> <!-- start TOP PANEL -->
      		...
      		<div class="avatarHolder"><img id="avatarImage" src="001.jpg" alt="avatar image" height="auto" width="100%" style="border-radius: 12px;" > </div>
      		<div id="chatbox">
...
<script type="text/javascript">
var botName = 'Amy';		// change this to your bot name
